...
## Selected Projects
- **[SEG 4180 Project](https://github.com/Integer-Conversion-Error/seg-4180-project)** - Collaborative software engineering project developed for SEG 4180, focused on translating requirements into a production-style implementation with clear milestones, iterative delivery, and team-based code reviews. Contributed across planning and execution, including feature design, implementation, issue tracking, and integration workflows to keep development structured and release-ready.
