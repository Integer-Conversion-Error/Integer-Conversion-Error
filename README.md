...
## Selected Projects
- **[SEG 4180 Project (ParkOpticon Synthetic Vehicle Detection)](https://github.com/Integer-Conversion-Error/seg-4180-project)** - Built a run-scoped synthetic-data pipeline for vehicle detection using Google Street View backgrounds, Gemini image editing, auto-label generation, manual QA in a web UI, leakage-safe panorama-group splits, and YOLO11 training. The final folded YOLO11n configuration reported precision **0.976**, recall **0.946**, **mAP@0.5 0.973**, and **mAP@0.5:0.95 0.939** on held-out Street View imagery, while documenting practical lessons around scene gating, cost discipline, and experiment isolation in the accompanying report.
